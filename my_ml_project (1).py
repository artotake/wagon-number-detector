...
# Ячейка 1: Импорт библиотек и монтирование диска
import os
import random
import shutil
...
# Пути к данным
BASE_PATH = '/content/drive/My Drive/test_task/digits/up+low'
...
# ========== ИЗМЕНЕНИЕ: добавляем переменную для подвыборки ==========
...
# ========== ИЗМЕНЕНИЕ: берем только первые N файлов ==========
if USE_N_FILES:
...
for epoch in range(1, num_epochs + 1):
    ...
    if np.isnan(train_loss):
        print("⚠️ Обнаружен nan loss! Обучение остановлено.")
